...
public class MongoDBTableCreation {
  ...
  public static void main(String[] args) throws ParseException {
		...
		db.getCollection("users").createIndex(new Document("user_id", 1), options);//1 means increasing order; -1 means decreasing order
		db.getCollection("items").createIndex(new Document("item_id", 1), options);//new document means {} in json
